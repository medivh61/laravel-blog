<template>
    <div class="p-8">
        ...
        <p class="text-center mt-6 text-lg font-light text-gray-500">
            В этом блоге вы можете посетить следующие разделы:
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3">
        <div class="p-8">
            ...
            <p class="font-light text-sm text-gray-500 mb-3">
                В этом блоге я делюсь своими мыслями и интересными статьями, <br>на которые натыкаюсь.
            </p>
            <Link :href="route('show.article')" class="text-indigo-500 flex items-center hover:text-indigo-600">
                Читать
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
        ...
        <div class="p-8">
            ...
            <p class="font-light text-sm text-gray-500 mb-3">
                Здесь я делюсь своими мыслями, переживаниями,
                открытиями, опытом, рассказами из жизни
            </p>
            <Link :href="route('show.note')" class="text-green-500 flex items-center hover:text-green-600" href="/">
                Читать
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
        ...
        <div class="p-8">
            ...
            <p class="font-light text-sm text-gray-500 mb-3">
                Чтобы как-то справиться с ураганом негатива из интернета, можно посмотреть полезные видео.
            </p>
            <Link :href="route('show.video')" class="text-red-500 flex items-center hover:text-red-600" href="/">
                Смотреть
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
